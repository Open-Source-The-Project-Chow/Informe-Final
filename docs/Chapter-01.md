...
El estado actual de las aplicaciones dirigidas al mercado de la artesanía se ha concentrado principalmente en la gestión de inventarios, la venta de los productos, y, en algunos casos, los pasos de producción de pedidos. Lo que estas aplicaciones existentes fallan en tratar es la falta de comunicación y confianza entre el artesano y el distribuidor al que envía su producto. Nuestro servicio tratará este problema al proporcionar una plataforma que permita a los artesanos manejar el estado de su pedido de forma simple, y que esta misma información sea visible para el distribuidor en todo mometo. Nuestro enfoque inicial será en los artesanos locales, y los distribuidores pequeños. Sabremos que tuvimos éxito cuando veamos que el número de pedidos completados en nuestra plataforma sea mayor a 100 en unos 2 meses de su salida.
