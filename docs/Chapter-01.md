...
| -------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Héctor Marcelo Rentería Puga     | Ingeniería de Software<br> <br>2024-2<br>Universidad Peruana de Ciencias Aplicadas          | ![Marcelo Renteria](../assets/img/marcelo.png)   | - Conocimiento Básico de C++ y Python.<br>- Experiencia en trabajo rápido y en equipo.<br>- Habilidad decente de ilustración y diseño.<br>- Capacidad de idear y trabajar en situaciones emergentes.               |
...
| Chamorro Acero,Salvador Edward   | Ingeniería de Software<br> <br>2024-2<br>Universidad Peruana de Ciencias Aplicadas          | ![Salvador Chamorro](../assets/img/salvador.png) | - Conocimiento en desarrollo con diferentes lenguajes de programacion tales como c++, c# y Javascript.<br> - Considero que tengo habilidades para trabajar bajo presion y comunicarme correctamente                |
...
Sin embargo, nos enfrentamos a desafíos significativos que pueden limitar la adopción de nuestra plataforma. La reticencia de algunos artesanos a adoptar soluciones tecnológicas, la competencia de plataformas de gestión generalistas que no abordan sus necesidades específicas y la necesidad de asegurar que nuestra solución sea accesible e intuitiva para talleres de diversos tamaños y complejidades, son obstáculos que debemos superar.

Para abordar estos retos, es esencial identificar y aprovechar las oportunidades del mercado. Nos enfocaremos en desarrollar herramientas de gestión que se adapten a las necesidades únicas de los artesanos, diferenciándonos de soluciones menos especializadas. La integración de automatizaciones en la gestión de inventarios y la planificación de la producción mejorará significativamente la eficiencia operativa. Además, colaboraremos estrechamente con expertos en técnicas tradicionales para garantizar la autenticidad y relevancia cultural de nuestra propuesta. Implementaremos niveles de suscripción ajustados al tamaño y tipo de taller, asegurando así que nuestra plataforma sea accesible para una amplia variedad de usuarios.
...
Nuestro usuario es el artesano que requiere herramientas de gestión para sus talleres de artesanía y bisutería, que le permitan trabajar más eficientenmente, encajando en su vida profesional, sea en la realización de pedidos, o gestión de su inventario en general. Para ellos, nuestro producto le ayudaría a ser más eficiente, y evitar la mayor cantidad de problemas durante la producción de sus trabajos.
...
- Será fácil de navegar y usar, con diseño y funciones intuitivas. La información de nuestro servicio debe presentarse de manera clara y concisa, asegurando el agrado del usuario.
- Habrá actualizaciones automáticas y notificaciones para ayudar a mantener a nuestros usuarios informados.
- Habrá una interfaz clara que muestre la información de cada etapa de producción, opciones de monitoreo y posibles acciones a tomar.
